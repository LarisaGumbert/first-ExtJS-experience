...
folder are mapped to the application's root namespace, 'TestApp01'. This is set in
`"app.json"`:
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'TestApp01' in the same way
as `"TestApp01/sass/src"`.
